...
parent      =  extends Combine[String] {
  def combine(x: String, <error>: <error>) = _root_.scala.Predef.???
} # -1,
parent span = <394..447>,
child       = def combine(x: String, <error>: <error>) = _root_.scala.Predef.??? # -1,
child span  = [424..428..453]
